    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeAvatarSuccess? "Your avatar has been successfully changed!"
                : "";
        ...
        public async Task<ActionResult> Index(IndexViewModel model)
        {
            ...
            if (cUser != null)
            {
                ...
                ViewBag.StatusMessage = "Your name has been succesfully changed!";
            }
            var userId = User.Identity.GetUserId();
        ...
        public async Task<ActionResult> ChangePassword(IndexViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    await SignInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);
                    ViewBag.Success = "Password has been successfully changed!";
                }
